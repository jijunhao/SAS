...
13(文教艺术用品)  14341  13203  19396 14691  94.600 17.800   6354 1.574
 ;
proc print data=data711;
run;

* 7-11(1) ;
proc princomp data=data711  prefix=z out=o711;
  var x1-x8;
run;
...
proc cluster data=o711 method=ave outtree=b711;
  var z1-z3;
run;
goptions  ftext="宋体";
proc tree data=b711 horizontal graphics;
  title  '使用类平均法的谱系聚类图';
run;
quit;
